...
// private static final int MAX_REQUESTS_PER_ITRVL = 2; // just to test needs to
// be bigger XD
...
// private final Map<String, RateLimitInfo> ipLimits = new
// ConcurrentHashMap<>();
...
// response.setStatus(404); // need to now what is the too many request status
// code
